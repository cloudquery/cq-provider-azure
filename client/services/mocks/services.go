...
// Source: github.com/cloudquery/cq-provider-azure/client/services (interfaces: DisksClient,StorageAccountClient,StorageContainerClient,MySQLServerClient,MySQLConfigurationClient)
