...
// Source: github.com/cloudquery/cq-provider-azure/client/services (interfaces: GroupsClient,KeyClient,VaultClient,StorageAccountClient,StorageContainerClient,MySQLServerClient,MySQLConfigurationClient)
