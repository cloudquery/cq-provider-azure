...
// Source: github.com/cloudquery/cq-provider-azure/client/services (interfaces: SqlDatabaseClient,SQLFirewallClient,SQLServerAdminClient,SqlServerClient,SQLServerBlobAuditingPolicies,SQLDatabaseBlobAuditingPoliciesClient)
