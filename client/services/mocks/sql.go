...
// Source: github.com/cloudquery/cq-provider-azure/client/services (interfaces: SqlDatabaseClient,SQLDatabaseBlobAuditingPoliciesClient,SQLFirewallClient,SQLServerAdminClient,SQLServerBlobAuditingPolicies,SqlServerClient)
