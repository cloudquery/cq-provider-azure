//go:generate mockgen -destination=./mocks/services.go -package=mocks  . DisksClient,StorageAccountClient,StorageContainerClient,MySQLServerClient,MySQLConfigurationClient
