...
//go:generate mockgen -destination=./mocks/sql.go -package=mocks . SqlDatabaseClient,SQLDatabaseBlobAuditingPoliciesClient,SQLFirewallClient,SQLServerAdminClient,SqlServerClient
package services
