//go:generate mockgen -destination=./mocks/services.go -package=mocks  . DisksClient,KeyClient,VaultClient,StorageAccountClient,StorageContainerClient,MySQLServerClient,MySQLConfigurationClient
...
//go:generate mockgen -destination=./mocks/monitor.go -package=mocks . LogProfilesClient,DiagnosticSettingsClient
