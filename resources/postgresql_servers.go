...
func PostgresqlServers() *schema.Table {
	return &schema.Table{
		...
		Columns: []schema.Column{
			...
			{
				Name:        "identity_type",
				Description: "Type - The identity type Set this to 'SystemAssigned' in order to automatically create and assign an Azure Active Directory principal for the resource Possible values include: 'SystemAssigned'",
				Type:        schema.TypeString,
			...
			{
				Name:        "sku_name",
				Description: "Name - The name of the sku, typically, tier + family + cores, eg B_Gen4_1, GP_Gen5_8",
				Type:        schema.TypeString,
				Resolver:    schema.PathResolver("Sku.Name"),
			},
			{
				Name:        "sku_tier",
				Description: "Tier - The tier of the particular SKU, eg Basic Possible values include: 'Basic', 'GeneralPurpose', 'MemoryOptimized'",
				Type:        schema.TypeString,
			...
			{
				Name:        "version",
				Description: "Version - Server version Possible values include: 'NineFullStopFive', 'NineFullStopSix', 'OneZero', 'OneZeroFullStopZero', 'OneZeroFullStopTwo', 'OneOne'",
				Type:        schema.TypeString,
				Resolver:    schema.PathResolver("ServerProperties.Version"),
			},
			{
				Name:        "ssl_enforcement",
				Description: "SslEnforcement - Enable ssl enforcement or not when connect to server Possible values include: 'SslEnforcementEnumEnabled', 'SslEnforcementEnumDisabled'",
				Type:        schema.TypeString,
				Resolver:    schema.PathResolver("ServerProperties.SslEnforcement"),
			},
			{
				Name:        "minimal_tls_version",
				Description: "MinimalTLSVersion - Enforce a minimal Tls version for the server Possible values include: 'TLS10', 'TLS11', 'TLS12', 'TLSEnforcementDisabled'",
				Type:        schema.TypeString,
			...
			},
			{
				...
				Description: "InfrastructureEncryption - Status showing whether the server enabled infrastructure encryption Possible values include: 'InfrastructureEncryptionEnabled', 'InfrastructureEncryptionDisabled'",
				Type:        schema.TypeString,
				Resolver:    schema.PathResolver("ServerProperties.InfrastructureEncryption"),
			},
			{
				Name:        "user_visible_state",
				Description: "UserVisibleState - A state of a server that is visible to user Possible values include: 'ServerStateReady', 'ServerStateDropping', 'ServerStateDisabled', 'ServerStateInaccessible'",
				Type:        schema.TypeString,
			...
			},
			{
				...
				Description: "StorageAutogrow - Enable Storage Auto Grow Possible values include: 'StorageAutogrowEnabled', 'StorageAutogrowDisabled'",
				Type:        schema.TypeString,
			...
			},
			{
				...
				Description: "PublicNetworkAccess - Whether or not public network access is allowed for this server Value is optional but if passed in, must be 'Enabled' or 'Disabled' Possible values include: 'PublicNetworkAccessEnumEnabled', 'PublicNetworkAccessEnumDisabled'",
				Type:        schema.TypeString,
		...
		Relations: []*schema.Table{
			{
				...
				Columns: []schema.Column{
					...
					},
					{
						...
						Description: "Status - The private link service connection status Possible values include: 'Approved', 'Pending', 'Rejected', 'Disconnected'",
						Type:        schema.TypeString,
			...
			},
			{
				...
				Columns: []schema.Column{
					...
					{
						Name:        "value",
						Description: "Value - Value of the configuration",
						Type:        schema.TypeString,
					...
					{
						Name:        "source",
						Description: "Source - Source of the configuration",
						Type:        schema.TypeString,
