...
func KeyVaultVaults() *schema.Table {
	return &schema.Table{
		...
		Columns: []schema.Column{
			...
			{
				Name:        "sku_name",
				Description: "Name - SKU name to specify whether the key vault is a standard vault or a premium vault Possible values include: 'Standard', 'Premium'",
				Type:        schema.TypeString,
			...
			},
			{
				...
				Description: "EnabledForDeployment - Property to specify whether Azure Virtual Machines are permitted to retrieve certificates stored as secrets from the key vault",
				Type:        schema.TypeBool,
				Resolver:    schema.PathResolver("Properties.EnabledForDeployment"),
			},
			{
				Name:        "enabled_for_disk_encryption",
				Description: "EnabledForDiskEncryption - Property to specify whether Azure Disk Encryption is permitted to retrieve secrets from the vault and unwrap keys",
				Type:        schema.TypeBool,
				Resolver:    schema.PathResolver("Properties.EnabledForDiskEncryption"),
			},
			{
				Name:        "enabled_for_template_deployment",
				Description: "EnabledForTemplateDeployment - Property to specify whether Azure Resource Manager is permitted to retrieve secrets from the key vault",
				Type:        schema.TypeBool,
				Resolver:    schema.PathResolver("Properties.EnabledForTemplateDeployment"),
			},
			{
				Name:        "enable_soft_delete",
				Description: "EnableSoftDelete - Property to specify whether the 'soft delete' functionality is enabled for this key vault If it's not set to any value(true or false) when creating new key vault, it will be set to true by default Once set to true, it cannot be reverted to false",
				Type:        schema.TypeBool,
			...
			},
			{
				...
				Description: "EnableRbacAuthorization - Property that controls how data actions are authorized When true, the key vault will use Role Based Access Control (RBAC) for authorization of data actions, and the access policies specified in vault properties will be  ignored (warning: this is a preview feature) When false, the key vault will use the access policies specified in vault properties, and any policy stored on Azure Resource Manager will be ignored If null or not specified, the vault is created with the default value of false Note that management actions are always authorized with RBAC",
				Type:        schema.TypeBool,
				Resolver:    schema.PathResolver("Properties.EnableRbacAuthorization"),
			},
			{
				Name:        "create_mode",
				Description: "CreateMode - The vault's create mode to indicate whether the vault need to be recovered or not Possible values include: 'CreateModeRecover', 'CreateModeDefault'",
				Type:        schema.TypeString,
		...
		Relations: []*schema.Table{
			{
				...
				Columns: []schema.Column{
					...
					{
						Name:        "object_id",
						Description: "ObjectID - The object ID of a user, service principal or security group in the Azure Active Directory tenant for the vault The object ID must be unique for the list of access policies",
						Type:        schema.TypeString,
			...
			},
			{
				...
				Columns: []schema.Column{
					...
					},
					{
						...
						Description: "ProvisioningState - Provisioning state of the private endpoint connection Possible values include: 'Succeeded', 'Creating', 'Updating', 'Deleting', 'Failed', 'Disconnected'",
						Type:        schema.TypeString,
			...
			},
			{
				...
				Columns: []schema.Column{
					...
					},
					{
						...
						Description: "Enabled - Determines whether or not the object is enabled",
						Type:        schema.TypeBool,
						Resolver:    schema.PathResolver("KeyProperties.Attributes.Enabled"),
					},
					{
						Name:        "attributes_not_before",
						Description: "NotBefore - Not before date in seconds since 1970-01-01T00:00:00Z",
						Type:        schema.TypeBigInt,
						Resolver:    schema.PathResolver("KeyProperties.Attributes.NotBefore"),
					},
					{
						Name:        "attributes_expires",
						Description: "Expires - Expiry date in seconds since 1970-01-01T00:00:00Z",
						Type:        schema.TypeBigInt,
					...
					{
						Name:        "kty",
						Description: "Kty - The type of the key For valid values, see JsonWebKeyType Possible values include: 'EC', 'ECHSM', 'RSA', 'RSAHSM'",
						Type:        schema.TypeString,
					...
					{
						Name:        "key_size",
						Description: "KeySize - The key size in bits For example: 2048, 3072, or 4096 for RSA",
						Type:        schema.TypeInt,
						Resolver:    schema.PathResolver("KeyProperties.KeySize"),
					},
					{
						Name:        "curve_name",
						Description: "CurveName - The elliptic curve name For valid values, see JsonWebKeyCurveName Possible values include: 'P256', 'P384', 'P521', 'P256K'",
						Type:        schema.TypeString,
