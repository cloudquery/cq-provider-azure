...
func SQLDatabases() *schema.Table {
	return &schema.Table{
		...
		Columns: []schema.Column{
			...
			{
				Name:        "collation",
				Description: "Collation - The collation of the database If createMode is not Default, this value is ignored",
				Type:        schema.TypeString,
			...
			},
			{
				...
				Description: "ElasticPoolName - The name of the elastic pool the database is in If elasticPoolName and requestedServiceObjectiveName are both updated, the value of requestedServiceObjectiveName is ignored Not supported for DataWarehouse edition",
				Type:        schema.TypeString,
			...
			{
				Name:        "read_scale",
				Description: "ReadScale - Conditional If the database is a geo-secondary, readScale indicates whether read-only connections are allowed to this database or not Not supported for DataWarehouse edition Possible values include: 'ReadScaleEnabled', 'ReadScaleDisabled'",
				Type:        schema.TypeString,
				Resolver:    schema.PathResolver("DatabaseProperties.ReadScale"),
			},
			{
				Name:        "sample_name",
				Description: "SampleName - Indicates the name of the sample schema to apply when creating this database If createMode is not Default, this value is ignored Not supported for DataWarehouse edition Possible values include: 'AdventureWorksLT'",
				Type:        schema.TypeString,
		...
		Relations: []*schema.Table{
			{
				...
				Columns: []schema.Column{
					...
					{
						Name:        "status",
						Description: "Status - The status of the database transparent data encryption Possible values include: 'TransparentDataEncryptionStatusEnabled', 'TransparentDataEncryptionStatusDisabled'",
						Type:        schema.TypeString,
