...
func StorageAccounts() *schema.Table {
	return &schema.Table{
		...
		Columns: []schema.Column{
			...
			{
				Name:        "sku_name",
				Description: "Name - Possible values include: 'StandardLRS', 'StandardGRS', 'StandardRAGRS', 'StandardZRS', 'PremiumLRS', 'PremiumZRS', 'StandardGZRS', 'StandardRAGZRS'",
				Type:        schema.TypeString,
				Resolver:    schema.PathResolver("Sku.Name"),
			},
			{
				Name:        "sku_tier",
				Description: "Tier - Possible values include: 'Standard', 'Premium'",
				Type:        schema.TypeString,
			...
			},
			{
				...
				Description: "UseSubDomainName - Indicates whether indirect CName validation is enabled Default value is false This should only be set on updates",
			...
			},
			{
				...
				Description: "KeyType - Encryption key type to be used for the encryption service 'Account' key type implies that an account-scoped encryption key will be used 'Service' key type implies that a default service key is used Possible values include: 'KeyTypeService', 'KeyTypeAccount'",
				Type:        schema.TypeString,
			...
			},
			{
				...
				Description: "KeySource - The encryption keySource (provider) Possible values (case-insensitive):  MicrosoftStorage, MicrosoftKeyvault Possible values include: 'KeySourceMicrosoftStorage', 'KeySourceMicrosoftKeyvault'",
				Type:        schema.TypeString,
				Resolver:    schema.PathResolver("AccountProperties.Encryption.KeySource"),
			},
			{
				Name:        "encryption_require_infrastructure_encryption",
				Description: "RequireInfrastructureEncryption - A boolean indicating whether or not the service applies a secondary layer of encryption with platform managed keys for data at rest",
				Type:        schema.TypeBool,
			...
			},
			{
				...
				Description: "LargeFileSharesState - Allow large file shares if sets to Enabled It cannot be disabled once it is enabled Possible values include: 'LargeFileSharesStateDisabled', 'LargeFileSharesStateEnabled'",
				Type:        schema.TypeString,
				Resolver:    schema.PathResolver("AccountProperties.LargeFileSharesState"),
			},
			{
				Name:        "routing_preference_routing_choice",
				Description: "RoutingChoice - Routing Choice defines the kind of network routing opted by the user Possible values include: 'MicrosoftRouting', 'InternetRouting'",
				Type:        schema.TypeString,
			...
			},
			{
				...
				Description: "AllowBlobPublicAccess - Allow or disallow public access to all blobs or containers in the storage account The default interpretation is true for this property",
				Type:        schema.TypeBool,
				Resolver:    schema.PathResolver("AccountProperties.AllowBlobPublicAccess"),
			},
			{
				Name:        "minimum_tls_version",
				Description: "MinimumTLSVersion - Set the minimum TLS version to be permitted on requests to storage The default interpretation is TLS 10 for this property Possible values include: 'TLS10', 'TLS11', 'TLS12'",
				Type:        schema.TypeString,
		...
		Relations: []*schema.Table{
			{
				...
				Columns: []schema.Column{
					...
					},
					{
						...
						Description: "VirtualNetworkResourceID - Resource ID of a subnet, for example: /subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/MicrosoftNetwork/virtualNetworks/{vnetName}/subnets/{subnetName}",
						Type:        schema.TypeString,
					...
					{
						Name:        "state",
						Description: "State - Gets the state of virtual network rule Possible values include: 'StateProvisioning', 'StateDeprovisioning', 'StateSucceeded', 'StateFailed', 'StateNetworkSourceDeleted'",
						Type:        schema.TypeString,
					},
				},
			},
			...
			},
			{
				...
				Columns: []schema.Column{
					...
					},
					{
						...
						Description: "Status - Indicates whether the connection has been Approved/Rejected/Removed by the owner of the service Possible values include: 'Pending', 'Approved', 'Rejected'",
						Type:        schema.TypeString,
					...
					},
					{
						...
						Description: "ActionRequired - A message indicating if changes on the service provider require any updates on the consumer",
						Type:        schema.TypeString,
						Resolver:    schema.PathResolver("PrivateEndpointConnectionProperties.PrivateLinkServiceConnectionState.ActionRequired"),
					},
					{
						Name:        "provisioning_state",
						Description: "ProvisioningState - The provisioning state of the private endpoint connection resource Possible values include: 'PrivateEndpointConnectionProvisioningStateSucceeded', 'PrivateEndpointConnectionProvisioningStateCreating', 'PrivateEndpointConnectionProvisioningStateDeleting', 'PrivateEndpointConnectionProvisioningStateFailed'",
						Type:        schema.TypeString,
