		...
		Relations: []*schema.Table{
			{
				...
				Columns: []schema.Column{
					...
					},
					{
						...
						Description: "DisableBgpRoutePropagation - Whether to disable the routes learned by BGP on that route table True means disable",
						Type:        schema.TypeBool,
			...
			},
			{
				...
				Columns: []schema.Column{
					...
					{
						Name:        "peering_state",
						Description: "PeeringState - The status of the virtual network peering Possible values include: 'VirtualNetworkPeeringStateInitiated', 'VirtualNetworkPeeringStateConnected', 'VirtualNetworkPeeringStateDisconnected'",
						Type:        schema.TypeString,
