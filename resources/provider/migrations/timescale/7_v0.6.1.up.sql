...
SELECT setup_tsdb_child('azure_mariadb_server_private_endpoint_connections', 'server_cq_id', 'azure_mariadb_servers',
                        'cq_id');
...
(
    ...
    "location"                           text,
    "tags"                               jsonb,
    CONSTRAINT azure_container_registries_pk PRIMARY KEY (cq_fetch_date, cq_id),
    UNIQUE (cq_fetch_date, cq_id)
);
SELECT setup_tsdb_parent('azure_container_registries');
...
CREATE INDEX ON azure_container_registry_network_rule_set_virtual_network_rules (cq_fetch_date, registry_cq_id);
SELECT setup_tsdb_child('azure_container_registry_network_rule_set_virtual_network_rules', 'registry_cq_id',
                        'azure_container_registries', 'cq_id');
...
(
    ...
    CONSTRAINT azure_container_registry_network_rule_set_ip_rules_pk PRIMARY KEY (cq_fetch_date, cq_id),
    UNIQUE (cq_fetch_date, cq_id)
);
CREATE INDEX ON azure_container_registry_network_rule_set_ip_rules (cq_fetch_date, registry_cq_id);
SELECT setup_tsdb_child('azure_container_registry_network_rule_set_ip_rules', 'registry_cq_id',
                        'azure_container_registries', 'cq_id');
...
(
    ...
    "location"           text,
    "tags"               jsonb,
    CONSTRAINT azure_container_registry_replications_pk PRIMARY KEY (cq_fetch_date, cq_id),
    UNIQUE (cq_fetch_date, cq_id)
);
CREATE INDEX ON azure_container_registry_replications (cq_fetch_date, registry_cq_id);
SELECT setup_tsdb_child('azure_container_registry_replications', 'registry_cq_id', 'azure_container_registries',
                        'cq_id');
