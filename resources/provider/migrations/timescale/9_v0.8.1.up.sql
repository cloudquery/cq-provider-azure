...
SELECT setup_tsdb_child('azure_iothub_hub_routing_endpoints_service_bus_queues', 'hub_cq_id', 'azure_iothub_hubs',
                        'cq_id');
...
SELECT setup_tsdb_child('azure_iothub_hub_routing_endpoints_service_bus_topics', 'hub_cq_id', 'azure_iothub_hubs',
                        'cq_id');
...
SELECT setup_tsdb_child('azure_iothub_hub_routing_endpoints_storage_containers', 'hub_cq_id', 'azure_iothub_hubs',
                        'cq_id');
