...
func SqlDatabases() *schema.Table {
	return &schema.Table{
		...
		Columns: []schema.Column{
			...
			{
				Name:        "kind",
				Description: "Kind - READ-ONLY; Kind of database",
				Type:        schema.TypeString,
			},
			{
				Name:        "managed_by",
				Description: "ManagedBy - READ-ONLY; Resource that manages the database.",
				Type:        schema.TypeString,
			},
			{
				Name:        "create_mode",
				Description: "CreateMode - Specifies the mode of database creation.  Default: regular database creation.  Copy: creates a database as a copy of an existing database",
				Type:        schema.TypeString,
			...
			{
				Name:        "status",
				Description: "Status - READ-ONLY; The status of the database",
				Type:        schema.TypeString,
				Resolver:    schema.PathResolver("DatabaseProperties.Status"),
			},
			{
				Name:        "database_id",
				Description: "DatabaseID - READ-ONLY; The ID of the database.",
				Type:        schema.TypeUUID,
			...
			},
			{
				...
				Description: "CurrentServiceObjectiveName - READ-ONLY; The current service level objective name of the database.",
				Type:        schema.TypeString,
				Resolver:    schema.PathResolver("DatabaseProperties.CurrentServiceObjectiveName"),
			},
			{
				Name:        "requested_service_objective_name",
				Description: "RequestedServiceObjectiveName - READ-ONLY; The requested service level objective name of the database.",
				Type:        schema.TypeString,
				Resolver:    schema.PathResolver("DatabaseProperties.RequestedServiceObjectiveName"),
			},
			{
				Name:        "default_secondary_location",
				Description: "DefaultSecondaryLocation - READ-ONLY; The default secondary region for this database.",
				Type:        schema.TypeString,
				Resolver:    schema.PathResolver("DatabaseProperties.DefaultSecondaryLocation"),
			},
			{
				Name:        "failover_group_id",
				Description: "FailoverGroupID - READ-ONLY; Failover Group resource identifier that this database belongs to.",
				Type:        schema.TypeString,
			...
			},
			{
				...
				Description: "RecoveryServicesRecoveryPointID - The resource identifier of the recovery point associated with create operation of this database.",
				Type:        schema.TypeString,
			...
			},
			{
				...
				Description: "LongTermRetentionBackupResourceID - The resource identifier of the long term retention backup associated with create operation of this database.",
				Type:        schema.TypeString,
			...
			},
			{
				...
				Description: "RestorableDroppedDatabaseID - The resource identifier of the restorable dropped database associated with create operation of this database.",
				Type:        schema.TypeString,
			...
			{
				Name:        "zone_redundant",
				Description: "ZoneRedundant - Whether or not this database is zone redundant, which means the replicas of this database will be spread across multiple availability zones.",
				Type:        schema.TypeBool,
				Resolver:    schema.PathResolver("DatabaseProperties.ZoneRedundant"),
			},
			{
				Name:        "license_type",
				Description: "LicenseType - The license type to apply for this database",
				Type:        schema.TypeString,
				Resolver:    schema.PathResolver("DatabaseProperties.LicenseType"),
			},
			{
				Name:        "max_log_size_bytes",
				Description: "MaxLogSizeBytes - READ-ONLY; The max log size for this database.",
				Type:        schema.TypeBigInt,
			...
			{
				Name:        "read_scale",
				Description: "ReadScale - The state of read-only routing",
				Type:        schema.TypeString,
				Resolver:    schema.PathResolver("DatabaseProperties.ReadScale"),
			},
			{
				Name:        "high_availability_replica_count",
				Description: "HighAvailabilityReplicaCount - The number of secondary replicas associated with the database that are used to provide high availability.",
				Type:        schema.TypeInt,
				Resolver:    schema.PathResolver("DatabaseProperties.HighAvailabilityReplicaCount"),
			},
			{
				Name:        "secondary_type",
				Description: "SecondaryType - The secondary type of the database if it is a secondary",
				Type:        schema.TypeString,
			...
			},
			{
				...
				Description: "AutoPauseDelay - Time in minutes after which database is automatically paused",
				Type:        schema.TypeInt,
				Resolver:    schema.PathResolver("DatabaseProperties.AutoPauseDelay"),
			},
			{
				Name:        "storage_account_type",
				Description: "StorageAccountType - The storage account type used to store backups for this database",
				Type:        schema.TypeString,
			...
			},
			{
				...
				Description: "MaintenanceConfigurationID - Maintenance configuration id assigned to the database",
				Type:        schema.TypeString,
		...
		Relations: []*schema.Table{
			{
				...
				Columns: []schema.Column{
					...
					{
						Name:        "kind",
						Description: "Kind - READ-ONLY; Resource kind.",
						Type:        schema.TypeString,
					},
					{
						Name:        "state",
						Description: "State - Specifies the state of the policy",
						Type:        schema.TypeString,
						Resolver:    schema.PathResolver("DatabaseBlobAuditingPolicyProperties.State"),
					},
					{
						Name:        "storage_endpoint",
						Description: "StorageEndpoint - Specifies the blob storage endpoint (e.g",
						Type:        schema.TypeString,
					...
					{
						Name:        "queue_delay_ms",
						Description: "QueueDelayMs - Specifies the amount of time in milliseconds that can elapse before audit actions are forced to be processed. The default minimum value is 1000 (1 second)",
						Type:        schema.TypeInt,
				...
				Relations: []*schema.Table{
					{
						...
						Columns: []schema.Column{
							...
							{
								Name:        "code",
								Description: "Code - READ-ONLY; The error code.",
								Type:        schema.TypeString,
							},
							{
								Name:        "message",
								Description: "Message - READ-ONLY; The error message.",
								Type:        schema.TypeString,
							},
						},
					},
			...
			},
			{
				...
				Columns: []schema.Column{
					...
					},
					{
						...
						Description: "DisabledAlerts - Specifies the semicolon-separated list of alerts that are disabled, or empty string to disable no alerts",
						Type:        schema.TypeString,
						Resolver:    schema.PathResolver("DatabaseSecurityAlertPolicyProperties.DisabledAlerts"),
					},
					{
						Name:        "email_addresses",
						Description: "EmailAddresses - Specifies the semicolon-separated list of e-mail addresses to which the alert is sent.",
						Type:        schema.TypeString,
						Resolver:    schema.PathResolver("DatabaseSecurityAlertPolicyProperties.EmailAddresses"),
					},
					{
						Name:        "email_account_admins",
						Description: "EmailAccountAdmins - Specifies that the alert is sent to the account administrators",
						Type:        schema.TypeString,
					...
					{
						Name:        "storage_account_access_key",
						Description: "StorageAccountAccessKey - Specifies the identifier key of the Threat Detection audit storage account",
						Type:        schema.TypeString,
						Resolver:    schema.PathResolver("DatabaseSecurityAlertPolicyProperties.StorageAccountAccessKey"),
					},
					{
						Name:        "retention_days",
						Description: "RetentionDays - Specifies the number of days to keep in the Threat Detection audit logs.",
						Type:        schema.TypeInt,
						Resolver:    schema.PathResolver("DatabaseSecurityAlertPolicyProperties.RetentionDays"),
					},
					{
						Name:        "use_server_default",
						Description: "UseServerDefault - Specifies whether to use the default server policy",
						Type:        schema.TypeString,
