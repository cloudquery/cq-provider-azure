		...
		Relations: []*schema.Table{
			...
			},
			{
				...
				Columns: []schema.Column{
					...
					{
						Name:        "vpn_client_configuration_vpn_client_address_pool",
					...
					{
						Name:        "vpn_client_configuration_vpn_client_root_certificates",
					...
					{
						Name:        "vpn_client_configuration_vpn_client_revoked_certificates",
					...
					{
						Name:        "vpn_client_configuration_vpn_client_protocols",
					...
					{
						Name:        "vpn_client_configuration_vpn_authentication_types",
					...
					{
						Name:        "vpn_client_configuration_vpn_client_ipsec_policies",
