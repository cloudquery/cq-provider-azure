...
\echo :check_id
\i sql/queries/monitor/azure_monitor_should_collect_activity_logs_from_all_regions.sql
\set check_id "12100.09ab2System.15 - 09.ab - 1"
\echo :check_id
\i sql/queries/compute/machines_without_log_analytics_agent.sql
\set check_id "12101.09ab1Organizational.3 - 09.ab - 1"
\echo :check_id
\i sql/queries/compute/scale_sets_without_log_analytics_agent.sql
\set check_id "12102.09ab1Organizational.4 - 09.ab - 1"
\echo :check_id
\i sql/queries/compute/guestconfiguration_windowsloganalyticsagentconnection_aine.sql
\set check_id "1212.09ab1System.1 - 09.ab - 1"
\echo :check_id
\i sql/queries/monitor/azure_monitor_log_profile_should_collect_logs_for_categories_write_delete_and_action.sql
\set check_id "1213.09ab2System.128 - 09.ab - 1"
\echo :check_id
\i sql/queries/security/asc_automatic_provisioning_log_analytics_monitoring_agent.sql
