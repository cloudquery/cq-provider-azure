...
\echo :check_id
\i sql/queries/compute/windows_machines_without_data_collection_agent.sql
\set check_id "0835.09n1Organizational.1 - 09.n - 2"
\echo :check_id
\i sql/queries/compute/vms_no_resource_manager.sql
\set check_id "0836.09.n2Organizational.1 - 09.n - 1"
\echo :check_id
\i sql/queries/compute/linux_machines_without_data_collection_agent.sql
\set check_id "0837.09.n2Organizational.2 - 09.n - 1"
\echo :check_id
\i sql/queries/account/locations_without_network_watchers.sql
