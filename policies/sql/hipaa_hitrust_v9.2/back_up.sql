...
\echo :check_id
\i sql/queries/sql/long-term_geo-redundant_backup_should_be_enabled_for_azure_sql_databases.sql
\set check_id "1617.09l1Organizational.23 - 09.l - 1"
\echo :check_id
\i sql/queries/sql/mysql_servers_without_geo_redundant_backups.sql
\set check_id "1618.09l1Organizational.45 - 09.l - 1"
\echo :check_id
\i sql/queries/sql/postgresql_servers_without_geo_redundant_backups.sql
\set check_id "1619.09l1Organizational.7 - 09.l - 1"
\echo :check_id
\i sql/queries/sql/mariadb_servers_without_geo_redundant_backups.sql
