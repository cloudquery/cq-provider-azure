...
\i sql/queries/compute/audit_virtual_machines_without_disaster_recovery_configured.sql

\set check_id "1635.12b1Organizational.2 - 12.b - 1"
\echo :check_id
\i sql/queries/keyvault/azure_key_vault_managed_hsm_should_have_purge_protection_enabled.sql
\set check_id "1635.12b1Organizational.2 - 12.b - 2"
\echo :check_id
\i sql/queries/keyvault/not_recoverable.sql
