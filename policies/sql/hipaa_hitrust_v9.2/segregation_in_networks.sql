...
\echo :check_id
\i sql/queries/container/containers_without_virtual_service_endpoint.sql
\set check_id "0805.01m1Organizational.12 - 01.m - 2"
\echo :check_id
\i sql/queries/network/virtualnetworkserviceendpoint_appservice_auditifnotexists.sql
\set check_id "0805.01m1Organizational.12 - 01.m - 3"
\echo :check_id
\i sql/queries/cosmosdb/cosmos_db_should_use_a_virtual_network_service_endpoint.sql
\set check_id "0805.01m1Organizational.12 - 01.m - 4"
\echo :check_id
\i sql/queries/eventhub/event_hub_should_use_a_virtual_network_service_endpoint.sql
\set check_id "0805.01m1Organizational.12 - 01.m - 5"
\echo :check_id
\i sql/queries/network/gateway_subnets_should_not_be_configured_with_a_network_security_group.sql
...
\echo :check_id
\i sql/queries/keyvault/vaults_with_no_service_endpoint.sql
\set check_id "0805.01m1Organizational.12 - 01.m - 8"
\echo :check_id
\i sql/queries/sql/sql_servers_with_no_service_endpoint.sql
\set check_id "0805.01m1Organizational.12 - 01.m - 9"
\echo :check_id
\i sql/queries/storage/accounts_with_no_service_endpoint_associated.sql
