...
\echo :check_id
\i sql/queries/compute/internet-facing_virtual_machines_should_be_protected_with_network_security_groups.sql
...
\echo :check_id
\i sql/queries/network/subnets_without_nsg_associated.sql
\set check_id "0809.01n2Organizational.1234 - 01.n - 13"
\echo :check_id
\i sql/queries/compute/vms_without_approved_networks.sql
