...
\echo :check_id
\i sql/queries/compute/machines_without_vulnerability_assessment_extension.sql
\set check_id "0709.10m1Organizational.1 - 10.m - 2"
\echo :check_id
\i sql/queries/sql/sql_databases_with_unresolved_vulnerability_findings.sql
\set check_id "0709.10m1Organizational.1 - 10.m - 6"
\echo :check_id
\i sql/queries/sql/managed_instances_without_vulnerability_assessments.sql
\set check_id "0709.10m1Organizational.1 - 10.m - 7"
\echo :check_id
\i sql/queries/sql/servers_without_vulnerability_assessments.sql
