...
\i sql/queries/compute/vms_utilizing_managed_disks.sql
\set check_id "7.2"
\echo "Executing check 7.2"
\i sql/queries/compute/os_and_data_disks_encrypted_with_cmk.sql
\set check_id "7.3"
\echo "Executing check 7.3"
\i sql/queries/compute/unattached_disks_are_encrypted_with_cmk.sql
\set check_id "7.4"
...
\i sql/queries/compute/vhds_not_encrypted.sql